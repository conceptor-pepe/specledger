...
This file defines the stateful agent workflow that sits above the low-level `SpecLedger` scripts.
...
- `specledger:start` / `specld:start`
- `specledger:continue` / `specld:next`
- `specledger:approve` / `specld:approve`
