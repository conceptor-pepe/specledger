...
## Community And Project Ops

- add `CODE_OF_CONDUCT.md`
- add `SECURITY.md`
- enable GitHub Discussions
- refine labels and milestone structure
- add a lightweight beta milestone board

## Product Quality

- improve `install/init.sh` output so new users understand next steps immediately
...
- finalize profile boundaries
- stabilize install surface
